  ...
  <div id="side_bar">
    ...
    <div id="map_content">
      <div id="glyph">
        ...
        <div id="slide-box" class="glyph_div glyph_div_border"><span class="glyphicon glyphicon-inbox font-glyph" aria-hidden="true"></span></div>
        ...
        <div id="slide-filter" class="glyph_div glyph_div_border"><span class="glyphicon glyphicon-cog font-glyph" aria-hidden="true"></span></div>
     </div>
         <div id="map"></div>
    </div>
